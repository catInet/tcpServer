...
namespace tacpServet
{
    public class WorkerRole : RoleEntryPoint
    {
        ...
        {
            Trace.TraceInformation("tacpServet is running");
        ...
        public override bool OnStart()
        {
            ...
            Trace.TraceInformation("tacpServet has been started");
        ...
        {
            Trace.TraceInformation("tacpServet is stopping");
            ...
            Trace.TraceInformation("tacpServet has stopped");
        }
