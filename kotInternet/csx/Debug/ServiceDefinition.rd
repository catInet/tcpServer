...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="kotInternet" generation="1" functional="0" release="0" Id="668846db-79ca-4345-ab28-20ec0435248c" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
    <group name="kotInternetGroup" generation="1" functional="0" release="0">
      ...
      <components>
        <groupHascomponents>
          <role name="tcpServer" generation="1" functional="0" release="0" software="C:\Users\Настя\Documents\Visual Studio 2013\Projects\kotInternet\kotInternet\csx\Debug\roles\tcpServer" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaWorkerHost.exe " memIndex="-1" hostingEnvironment="consoleroleadmin" hostingEnvironmentVersion="2">
            <componentports>
        ...
        <groupHascomponents>
          <role name="tcpServerPublish" generation="1" functional="0" release="0" software="C:\Users\Настя\Documents\Visual Studio 2013\Projects\kotInternet\kotInternet\csx\Debug\roles\tcpServerPublish" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaWorkerHost.exe " memIndex="-1" hostingEnvironment="consoleroleadmin" hostingEnvironmentVersion="2">
            <componentports>
  ...
  <implements>
    <implementation Id="f68473e8-9a9d-4972-b44e-3893a9877af3" ref="Microsoft.RedDog.Contract\ServiceContract\kotInternetContract@ServiceDefinition">
      <interfacereferences>
        <interfaceReference Id="ba603c14-4133-4f6b-96e5-b0c3160fc356" ref="Microsoft.RedDog.Contract\Interface\tcpServer:listener@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/kotInternet/kotInternetGroup/tcpServer:listener" />
          </inPort>
        </interfaceReference>
        <interfaceReference Id="9b641dba-93c8-475f-be66-d1e9b74d18b1" ref="Microsoft.RedDog.Contract\Interface\tcpServerPublish:listenerPublish@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/kotInternet/kotInternetGroup/tcpServerPublish:listenerPublish" />
          </inPort>
        </interfaceReference>
