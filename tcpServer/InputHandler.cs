...
{   //парсит строку входных данных
    ...
    class InputHandler
    {
        public static string handleInputString(string instr, long timestamp) 
        {
            string outstr;
        ...
        private static Dictionary<string, double> computeFeautures(Dictionary<string, List<double>> valuesDict)
        {
            ...
            var acc_3dstat = new _3DStatistic(valuesDict["acc_x"], valuesDict["acc_y"], valuesDict["acc_z"]),
        ...
        private static string generateJSONOutput(Dictionary<string, double> featuresDict, long timestamp)
        {
            //string outstring = "";
